...
#ggplot(data.frame(propertylandusetypeid=df$propertylandusetypeid, res = df$logerror - pred.gbm_all), aes(factor(propertylandusetypeid),res)) + geom_bar(position = "dodge", stat = "summary", fun.y = "mean")
