...
for(i in c(10, 30, 60, 90, 120, 150, 180, 360 )) {
...
df[df, sales_log_rm_010_1m := i.sales_log_rm_010, on=.(date_1m = date, store_nbr, family)]
...
```{r submit, echo=FALSE}
  ...
  file = file.path(working_folder, "StoreSales/submit_v9.lgb.csv")
