...
zero_inf_vars.rgs = c("geo_subContinent_n","geo_country_se3","geo_city_n","device_operatingSystem_sec","device_operatingSystem_n","trafficSource_source_n", "trafficSource_medium_n",
 ...
 "totals_pageviews_sd_log", "totals_hits_log", "totals_hits_sd_log", "day_diff_sd_log", "device_operatingSystem_main", "geo_networkDomain_levels", "geo_networkDomain_is_edu", "geo_subContinent_is_SoutheastAsia",  
...
mon_inc_vars = c('totals_pageviews_max','totals_pageviews') #totals_pageviews_max_log
mon_dec_vars = c()
...
## Save probability model (parametric search)
