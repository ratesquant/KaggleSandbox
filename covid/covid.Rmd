...
ggplot(df_freq, aes(freq, log10(y) )) + geom_step(direction = 'mid') + 
  geom_vline(xintercept = c(1/7, 12/365, 3/365), color = 'red')

ggplot(df_freq, aes(1/freq, log10(y) )) + geom_step(direction = 'mid') + 
  geom_vline(xintercept = c(7, 30), color = 'red')
...
summary(lm('new_deaths_avg_7d ~ new_cases_rm_56', df))

#summary(lm('new_deaths ~ new_deaths_pred', df))
#summary(lm('new_deaths ~ new_cases_rm_50', df))

model.lm = lm('new_deaths_avg_7d ~ new_cases_rm_56', df)
