...
all_vars = c('totals_pageviews_sd_log','totals_pageviews_log','count_log','totals_pageviews_max_log','device_deviceCategory','device_browser_major','geo_country_major','geo_city_major','date_wday1','trafficSource_medium', 'totals_hits_sd_log','day_diff_sd_log','day_diff_avg','geo_city_set1','geo_networkDomain_level2_major', 'device_operatingSystem_n','mobile_n',
             'date_m1_pct_pos','date_m4_pct_pos','date_m5_pct_pos','date_m6_pct','date_m7_pct', 'date_m8_pct_pos','date_m9_pct_pos', 'date_m10_pct','date_m11_pct_pos', 'date_m12_pct',
...
gbm.roc.area(actual.pd[tindex], pred.pd[tindex]) #0.9898181
...
#all vars
plots = llply(names(df_agg) %!in_set% c('fullVisitorId','totals_bounces_max', all.vars(formula.pd)), function(var_name) {
  print(var_name)
  p = plot_profile(pred.pd[tindex], actual.pd[tindex],df_agg[[var_name]][tindex], error_band = 'binom') +
    ggtitle(var_name) +  theme(title =element_text(size=6))
  return( p )
...
cv-10: 1.10421
                                                                ...
                                                                var    rel.inf
totals_hits_log                                     totals_hits_log 28.3940659
count_log                                                 count_log 26.6052725
device_operatingSystem_main             device_operatingSystem_main 10.0952575
channelGrouping_main                           channelGrouping_main  7.8094028
totals_hits_sd                                       totals_hits_sd  7.3980833
geo_city_set1                                         geo_city_set1  4.7331874
date_wnd_pct                                           date_wnd_pct  4.6577256
device_browser_main                             device_browser_main  2.6090695
totals_bounces                                       totals_bounces  1.8896194
device_deviceCategory                         device_deviceCategory  1.8010015
geo_networkDomain_is_edu                   geo_networkDomain_is_edu  1.2172306
date_m3_pct_pos                                     date_m3_pct_pos  1.1931869
geo_networkDomain_is_cantv               geo_networkDomain_is_cantv  0.7633374
date_m4_pct_pos                                     date_m4_pct_pos  0.4821137
geo_subContinent_is_SoutheastAsia geo_subContinent_is_SoutheastAsia  0.1874983
geo_subContinent_is_EasternAsia     geo_subContinent_is_EasternAsia  0.1639476
...
plot_gbmiterations(model.rgs) # 1.10229
