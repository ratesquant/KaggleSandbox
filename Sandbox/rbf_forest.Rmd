...
ggplot(df[ sample( which(train_index), 0.1*sum(train_index))], aes(p_cont1, p_cont13)) +  geom_point(size = 0.3, alpha = 0.3)
ggplot(df[ sample( which(train_index), 0.1*sum(train_index))], aes(cont1, cont13)) + geom_point(size = 0.3, alpha = 0.3)
ggplot(df[ sample( which(train_index), 0.1*sum(train_index))], aes(n_cont1, n_cont13)) + geom_point(size = 0.3, alpha = 0.3)
