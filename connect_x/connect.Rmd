...
```{r timing_data}
 ...
 ggplot(df_t[min_depth == max_depth], aes(move, nodes)) + geom_point(alpha = 0.5)
 ggplot(df_t, aes(move, elapsed)) + geom_point(alpha = 0.5)
 
 ggplot(df_t, aes(move, elapsed)) + geom_point(alpha = 0.5)
 ggplot(df_t, aes(move, nodes)) + geom_point(alpha = 0.5)
 
 ggplot(df_t, aes(move, min_depth )) + geom_point(alpha = 0.5)
 ggplot(df_t, aes(move, max_depth )) + geom_point(alpha = 0.5)
