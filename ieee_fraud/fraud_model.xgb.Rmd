...
ggplot(df[s_index,], aes(V294_307_diff, V317)) + geom_point()
...
var_excluded =c('D2', 'D15', 'D4', 'D10', 'D1', 'D11', 'D12', 'D6', 'D7','id_20','id_13','id_02','C2','C4','C6','C8','C14','C10','C13','C11','V307','V91','V90','V294')
...
#correlation
num_vars  = as.character(importance_matrix$Feature[1:60]) %in_set% names(which(sapply(df, is.numeric)))
...
ggsave(filename = file.path(working_folder,"ieee_fraud/cor_matrix.pdf"), plot = ggplotGrob(cor_plot), device = 'pdf', width = 14, height = 8.5, dpi = 240)
