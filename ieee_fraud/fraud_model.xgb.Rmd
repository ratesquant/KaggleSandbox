...
### CV Random Search ----------------
n_runs = 10
my_params = data.table(depth = sample(seq(10),n_runs), eta = runif(n_runs, 0.001, 0.03), subsample = runif(n_runs, 0.7, 1.0), gamma = runif(n_runs, 0, 1.0), min_child_weight =sample(seq(10),n_runs))
