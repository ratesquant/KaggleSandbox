...
```{r load_data}
files_vax = list.files(file.path(working_folder,'vaers/data/'), glob2rx('*VAERSVAX.csv'), full.names = TRUE)
files_sym = list.files(file.path(working_folder,'vaers/data/'), glob2rx('*VAERSSYMPTOMS.csv'), full.names = TRUE)
files_dat = list.files(file.path(working_folder,'vaers/data/'), glob2rx('*VAERSDATA.csv'), full.names = TRUE)
