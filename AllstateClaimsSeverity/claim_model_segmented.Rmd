...
df = load_claim_data(file.path(folder, 'input'), min_count = 30, max_cat_levels = 4, scale_by_count = FALSE)
...
max_it = data.frame(level = levels(df$cat80), it = c(10, 100, 20, 100)*1000)
