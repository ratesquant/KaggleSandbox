...
df_s = df[date<'2020-01-01',.(date, uer, iuic = iuic)][order(date)]
...
ggplot(coef_path[var_name != '(Intercept)'][lambda == cvob3$lambda.1se, ], aes(var_name,adj_coef, group = lambda)) + 
    geom_bar(stat = 'identity', position = 'dodge') +  theme(axis.text.x  = element_text(angle=90))
