...
solution_file = file.path(working_folder,'Santa/data/population.10.rds')
...
saveRDS(res@population, file.path(working_folder,'Santa/data/population.10.rds'))
...
cpp_tour = read.csv(file.path(working_folder,'Santa/data/cpp.solution.tour.1k.txt'), header = FALSE)
if(nrow(df)<10000){
ggplot(df, aes(X, Y)) + geom_point() + 
...
con_tour = read.csv(file.path(working_folder,'Santa/data/concorde_tour.1k.txt'), header = FALSE)
if(nrow(df)<10000){
ggplot(df, aes(X, Y)) + geom_point() + 
