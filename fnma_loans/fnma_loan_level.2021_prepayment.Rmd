...
refi_scurve * refi_ramp * refi_als * refi_fico * refi_cltv * refi_occ * refi_burn * media_scurve * refi_chn * refi_hpal * refi_hpa * refi_dti * refi_boost * refi_geo * refi_mi * refi_boost2 * refi_sato * refi_hval * refi_purpose * refi_nounit +   curt_als * curt_factor
...
params = list('turn_scurve_low' = cpr2smm(5.721711), 'turn_scurve_high' = cpr2smm( 10.5), 'turn_scurve_shift' =  -10.99395, 'turn_scurve_slope' = 34.38446 , 
              ...
              'curt_als_y' = c(cpr2smm(80),cpr2smm(20), cpr2smm(12),cpr2smm(10), 0.0),
              'curt_factor_x' = c(0.1, 0.2, 0.5, 0.75), 
              'curt_factor_y' = c(2.4, 1.8, 1.3, 1.0)
              )  
...
objective_function(df, t_index_v) #  -6.490202
#plot_act_vs_model2(df, 'upb', df$upb < 100, bucket_count = 100)
plot_act_vs_model2(df, 'ei', bucket_count = 40)
plot_act_vs_model2(df, 'date', bucket_count = 20)
plot_act_vs_model2(df, 'cum_ei', bucket_count = 100)
plot_act_vs_model2(df, 'CLTV', df$ei <0, bucket_count = 100)
...
plot_act_vs_model2(df, 'LOAN_AGE',df$ei < 0, bucket_count = 20)
