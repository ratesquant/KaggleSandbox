...
all_vars = c('totals_pageviews_sd_log','totals_pageviews_log','count_log','totals_pageviews_max_log','device_deviceCategory','device_browser_major','geo_country_major','geo_city_major','date_wday1','trafficSource_medium', 'totals_hits_sd_log','day_diff_sd_log','geo_city_set1','geo_networkDomain_level2_major', 'device_operatingSystem_n','first_month','mobile_n')
...
mon_inc_vars = c('totals_pageviews_log','totals_pageviews_max_log','count_log','totals_pageviews_sd_log','day_diff_sd_log')
...
gbm.roc.area(actual.pd[tindex], pred.pd[tindex]) #0.9893948
...
plot_profile(pred.pd[tindex], actual.pd[tindex],factor(df_agg$mobile_n[tindex]), error_band = 'binom')
