...
models_boost =  rbf_boost.create(dfs, target, 4, max_nodes = 8*1024, n_runs = 3, max_it = 15, growth_rate = 0.5*(1 + sqrt(5)), kernel_fun = rbf_mquad_kernel, dist_fun = 'L2', adaptive = TRUE)
