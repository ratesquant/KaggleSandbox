...
df[, cat_11_2_ex  := fct_infreq(fct_lump_prop(stri_join(cat11, cat2),  0.006, other_level = "OT")) ]
df[, cat_16_15_ex := fct_infreq(fct_lump_prop(stri_join(cat16, cat15), 0.006, other_level = "OT")) ]
...
plot_profile(df$target_lgb[train_index], df$target[train_index], df$cat_11_2_ex[train_index])
...
```{r submit, echo=FALSE}
  ...
  file = file.path(working_folder, "Playground/Mar2021/submit_v9.lgb.csv")
