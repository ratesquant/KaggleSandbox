...
ggplot(df_agg, aes(date, hr_1m_drop, label = sprintf('%d', floor(hr_1m_drop) ) ))           + geom_point() + geom_smooth(method = 'loess') + geom_text_repel(size = 3)
ggplot(df_agg, aes(date, hr_2m_drop, label = sprintf('%d', floor(hr_2m_drop) ) ))           + geom_point() + geom_smooth(method = 'loess') + geom_text_repel(size = 3)
