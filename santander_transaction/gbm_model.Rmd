...
fwrite(var_inf,  file.path(working_folder,"santander_transaction/gbm.var_inf.d6.csv"))
...
plots = plot_gbmpartial(model.gbm, best_it.gbm, imp_vars %!in_set% c(mon_dec_vars,mon_inc_vars), output_type = 'response')
marrangeGrob(plots, nrow = 6, ncol = 7, top = NULL)


gplots = lapply(plots, ggplotGrob)
ggsave(filename = file.path(working_folder,"santander_transaction/gbm.pd.d6.pdf"), plot = marrangeGrob(gplots, nrow=4, ncol=7), device = 'pdf', width = 14, height = 8.5, dpi = 240)
...
gplots = lapply(plots, ggplotGrob)
ggsave(filename = file.path(working_folder,"santander_transaction/gbm.profiles.d6.pdf"), plot = marrangeGrob(gplots, nrow=4, ncol=7), device = 'pdf', width = 14, height = 8.5, dpi = 240)
