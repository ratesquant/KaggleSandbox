...
formula.all = formula (paste( 'price_log ~', paste(names(df) %!in_set% c(non_vars), collapse = '+')) )
...
plot_gbminfluence(vars.importance2)
print(vars.importance2)
...
plot_gbminfluence(vars.importance3)
print(vars.importance3)
...
plot_gbminfluence(vars.importance_cv)
print(vars.importance_cv)
...
## GBM on all vars (degree = 3, CV)
```{r gbm, fig.width = 8, fig.height = 6, dpi = 150, eval = TRUE, echo=FALSE}
