...
##  XGBOOST Model: meter == 2
 1:        square_feet_log 0.3000487379 0.182594505 0.136047401
 2:             rank_lm_m0 0.1534965410 0.161310901 0.114358998
 3:                site_id 0.1042949422 0.031780167 0.028484379
 4:                cl15_m0 0.0957763783 0.012966152 0.008172102
 5:        air_temperature 0.0782356340 0.025423885 0.032864928
 6:    air_temperature_m24 0.0562553987 0.028999691 0.041521556
 7:            primary_use 0.0531585815 0.038192207 0.050154769
 8:  air_temperature_max24 0.0345067577 0.026258022 0.028639283
 9:             year_built 0.0285191289 0.057247584 0.023840852
10:                cl20_m0 0.0199781767 0.015141827 0.015351736
```{r xgb_model_m2}
   obj_var = 'meter_reading_log'
...
plot_profile(pred.xgb.m2_t, actual,factor(df[['rank_lm_m0']][t_index.m2]), error_band = 'normal')
plot_profile(pred.xgb.m2_t, actual,factor(df[['cl20_m0']][t_index.m2]), error_band = 'normal')
...
##  XGBOOST Model: meter == 3
 1:        square_feet_log 0.2740962847 0.103304651 0.121364526
 2:             rank_lm_m0 0.1815155167 0.091465655 0.091856012
 3:                site_id 0.1579209493 0.024544715 0.014626526
 4:    air_temperature_m24 0.0976981516 0.051183581 0.044845708
 5:            primary_use 0.0400309950 0.021913477 0.041214570
 6:             time_month 0.0375326419 0.047235958 0.061210008
 7:        air_temperature 0.0243496767 0.023145964 0.023984012
 8:             year_built 0.0215813281 0.028295108 0.022817086
 9:  air_temperature_min24 0.0200910701 0.034281115 0.025018476
10:                cl10_m0 0.0198271967 0.011653613 0.018962024
```{r xgb_model_m3}
   obj_var = 'meter_reading_log'
...
plot_profile(pred.xgb.m3_t, actual,factor(df[['rank_lm_m0']][t_index.m3]), error_band = 'normal')
plot_profile(pred.xgb.m3_t, actual,factor(df[['cl20_m0']][t_index.m3]), error_band = 'normal')
...
index = df$date[t_index.m3] > '2016-02-01'
...
#df_building[building_id == 740,]
index = df$building_id[t_index.m3] == 187 #434, 404, 1169, 954, 551, 1221, 1092, 1135, 831, 849, 857,416, 740, 434 , 805, 53, 301, 1019, 816, 740, 1212, 805, 53, 301
