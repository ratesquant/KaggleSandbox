...
full_df$CabinNumber = as.factor(25*ceil(as.numeric(cabins_df$CabinNumber)/25))
...
results$gbm_title =pred.gbm_title #0.79904
results$gbm_cabin =pred.gbm_cabin 
results$glm_s = pred.glm_s
results$nnet = pred.nnet
results$rf = pred.rf
results$rf_cabin = pred.rf_cabin
...
```{r titles_names, fig.width = 8, fig.height = 6, dpi = 100}
