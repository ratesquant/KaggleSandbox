...
refi_scurve * refi_ramp * refi_als * refi_fico * refi_cltv * refi_occ * refi_burn * media_scurve * refi_chn * refi_hpal * refi_hpa * refi_dti * refi_boost * refi_geo * refi_mi * refi_boost2 * refi_sato * refi_hval * refi_purpose * refi_nounit * refi_prop +   curt_als * curt_factor
...
#74.73414352 16.24744159 13.71078677 10.08456190  0.07797535
#0.1458336 0.5621026 0.6376452 0.9552909 0.7134339 1.2189778 1.2942568
...
objective_function(df) # -6.728516

plot_act_vs_model2(df, 'OCC_STAT',  bucket_count = 10)
...
plot_act_vs_model2(df, 'CLTV', bucket_count = 50)
...
my_vars = unique(c('ei', 'LOAN_AGE', 'season_s',  'upb', 'PURPOSE', 'OCC_STAT', 'CHANNEL','PROP', 'CSCORE_B',  'CLTV', 'OLTV',  'cum_ei','cum_eim', 'media_ei_lin','media_ei_log', 'hpa', 'hpa_life', 'CURR_RATE','MI_PCT',
            'uer', 'uer_1m36', 'uer_1m60', 'uer_3m36',  'factor','DTI','no_cscore', 'sato', 'house_value', 'NO_UNITS', 'no_cscore', 'NUM_BO', 'orig_year', 'ei_ratio'))
