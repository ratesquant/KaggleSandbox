...
plot_gbminfluence(vars.importance_res[vars.importance_res$rel.inf>0.1,])
kable(vars.importance_res[vars.importance_res$rel.inf>=0.1,])

imp_vars = as.character(vars.importance_res$var)[vars.importance_res$rel.inf>=0.1]
