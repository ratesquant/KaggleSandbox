...
models_boost =  rbf_boost.create(df[,.(x, y)], df$target, 1, max_nodes = 256, n_runs = 10, max_it = 100, growth_rate = 2.0,shrink_kernel = 0.7, kernel_fun = rbf_linear_kernel, dist_fun = 'L1', adaptive = TRUE)
