...
params = expand.grid(n_pages = seq(10), n_points = c(64, 256, 1024), dpi = c(120, 240, 300, 360))
#params = expand.grid(n_pages = c(1), n_points = c(64, 256, 1024), dpi = c(120))

res = ldply(seq(nrow(params)), function(i){
  
  elapsed = save_pdf_test(filename_pdf, params$n_pages[i], params$n_points[i])
