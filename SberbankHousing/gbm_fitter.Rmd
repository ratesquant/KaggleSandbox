...
df  =  merge(df[,names(df) != 'timestamp'], macro_lag1[,names(macro_lag1) != 'timestamp_lag'], by.x = 'date', by.y = 'date_lag1', all.x = TRUE)
df  =  merge(df[,names(df) != 'timestamp'], macro_lag2[,names(macro_lag2) != 'timestamp_lag'], by.x = 'date', by.y = 'date_lag2', all.x = TRUE)
...
var_cor = head(var_cor[order(abs(var_cor$cor), decreasing = TRUE),], 18)
