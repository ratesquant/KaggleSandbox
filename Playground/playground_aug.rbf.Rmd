...
models_boost =  rbf_boost.create(dfs, target, 2, max_nodes = 1024, n_runs = 10, max_it = 15, growth_rate = 2, kernel_fun = rbf_mquad_kernel, dist_fun = 'L1', adaptive = TRUE)
...
cv_res = rbf_boost.create_cv(dfs, target, 2, max_nodes = 4096, n_runs = 10, max_it = 50, growth_rate = 1.5, nfolds = 5, kernel_fun = rbf_mquad_kernel, dist_fun = 'L2', adaptive = FALSE )
...
```{r submit, echo=FALSE}
  ...
  file = file.path(working_folder, "Playground/Aug2021/submit_v4.rbf.csv")
