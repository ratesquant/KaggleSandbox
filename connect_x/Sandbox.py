...
def negamax_agent_ex(obs, config):    
    ...
    if made_moves == 0: #first move
        ...
        while True:                     
            run_time_1 = time() 
            best_score, best_column, temp_evals = negamax(obs.board[:], obs.mark, my_depth, -size, size, made_moves)            
...
run_tests(tests_hard, 'Test_L2_R1_HARD.v5')
