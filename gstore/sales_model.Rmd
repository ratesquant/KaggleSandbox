...
exclude_vars = c('fullVisitorId','is_train','first_date','last_date','revenue','is_revenue', #id and outcome var
                                     'geo_city','geo_country','geo_region','geo_region_major', 'geo_subContinent', #too many levels
...
summary(lm('actual ~ model ', data.frame(actual = actual[tindex], model = pred.rev[tindex]))) #0.4273
#ggplot(data.frame(actual = actual[tindex], model = pred.rgs[tindex]), aes(model, actual)) + geom_point()
